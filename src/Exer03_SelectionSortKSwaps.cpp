...
// 1. PURE LOGIC
void DSSWithK(int n, int k, vector<int>& arr) {
    int passes = min(n - 1, k);
...
// 3. LOCAL TESTS
void runLocalTests() {
    cout << "=== Test Q3 (Selection Sort K Swaps) ===\n\n";
    ...
    // --- Case 1 ---
    int k1 = 2;
    vector<int> vec1 = {29, 64, 14, 37, 13};
    string test1 = "29 64 14 37 13 (k = 2)";
    string expected1 = "13 14 29 37 64";
    DSSWithK(vec1.size(), k1, vec1);
    ...
    // --- Case 2 ---
    int k2 = 1;
    vector<int> vec2 = {64, 25, 12, 22, 11, 90};
    string test2 = "64 25 12 22 11 90 (k = 1)";
    string expected2 = "11 25 12 22 64 90";
    DSSWithK(vec2.size(), k2, vec2);
